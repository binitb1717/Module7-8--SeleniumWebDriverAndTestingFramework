...
public class Que2 {
	...
	/*To open a particular sheet of selected excel sheet*/
	Sheet Sht=wrkbuk.getSheet("Sheet2");
	...
	DTA[i][j]= cl.getStringCellValue();	
		...
		WebDriver driver;
		@Test (dataProvider = "Tjs")
		public void tst(String keyword) throws InterruptedException, InvalidFormatException, IOException {
